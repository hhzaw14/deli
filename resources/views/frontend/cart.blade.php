            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                   ...
                   <textarea class="form-control mb-5" placeholder="Address" rows="4" cols="50" id="address"></textarea>
                </div>
                <div class="col-lg-6">
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex align-items-center justify-content-between mb-4"><strong class="text-uppercase small font-weight-bold">Total</strong><span class="shoppingcartTotal"></span></li>
                    <li>
                      <form action="#">
